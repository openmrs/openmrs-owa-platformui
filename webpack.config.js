...
const THIS_APP_ID = 'openmrs-owa-platformui';
...
let getConfig = function() {
  ...
  try {
    ...
    config = {
      LOCAL_OWA_FOLDER: '/Users/dondrzzy/openmrs/server1/owa/',
      APP_ENTRY_POINT:
        'http://localhost:8080/openmrs/owa/openmrs-owa-platformui/index.html'
    };
...
if (env === 'production') {
  ...
  plugins.push(
    new WebpackOnBuildPlugin(function(stats) {
      ...
      let output = THIS_APP_VERSION
        ? fs.createWriteStream(`${THIS_APP_ID}-${THIS_APP_VERSION}.zip`)
...
let webpackConfig = {
  quiet: false,
  entry: {
    app: `${__dirname}/app/js/openmrs-owa-platformui`,
    css: `${__dirname}/app/css/openmrs-owa-platformui.css`,
